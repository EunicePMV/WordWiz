# random letters na magaappear sa pool

from trie import *

class LetterGenerator():

    def __init__(self, trie: Trie, mmWord: str) -> None:
        # trie to search a word
        self.trie = trie
        # letters in the mastermind word
        self.mmWord = [letter for letter in mmWord]
    ...
    def letter_generate(self):
        ...
        while True:
            ...
            if len(self.candidate_words) >= 100:
                ...
                print("words: ", self.candidate_words)
                print("len: ", len(self.candidate_words))
...
t.load()
mmWord = "socky"
lg = LetterGenerator(t, mmWord)
final = lg.letter_generate()
print("final: ")
print(final)